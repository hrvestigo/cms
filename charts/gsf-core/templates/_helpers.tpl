...
{{/*
gsf-core image pull policy
*/}}
{{- define "gsf-core.app.imagePullPolicy" -}}
...
Selector labels
*/}}
{{- define "gsf-core.selectorLabels" -}}
app.kubernetes.io/name: {{ include "gsf-core.name" . }}
...
Volumes
*/}}
{{- define "gsf-core.volumes" -}}
{{- with .Values.customVolumes -}}
{{- toYaml . | default "" }}
{{ "" }}
{{- end -}}
- name: {{ include "gsf-core.name" . }}-secret
  secret:
    secretName: {{ include "gsf-core.name" . }}-secret
    items:
      - path: password.conf
        key: password.conf
- name: {{ include "gsf-core.name" . }}-configmap
  configMap:
    name: {{ include "gsf-core.name" . }}-configmap
- name: server-cert
...
{{/*
Mounts for gsf-core application
*/}}
{{- define "gsf-core.mounts" -}}
...
*/}}
{{- define "gsf-core.db.connectionParams" -}}
{{- $atts := list -}}
